"""
@brief Sample code testing OpenCV smoothing filters like GaussianBlur, medianBlur and bilateralFilter
"""
...
def main(argv):
    ...
    if src is None:
        ...
        print ('Usage: smoothing.py [image_name -- default cat.jpg] \n')
        return -1
